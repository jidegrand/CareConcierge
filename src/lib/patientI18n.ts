...
const PATIENT_COPY = {
  en: {
    ...
    voiceOnLabel: 'Turn on voice',
    voiceOffLabel: 'Turn off voice',
    voiceConfirmation: '{request} requested',
  },
  es: {
    language: 'Idioma',
    ...
    voiceOnLabel: 'Activar voz',
    voiceOffLabel: 'Desactivar voz',
    voiceConfirmation: '{request} solicitado',
  },
  fr: {
    language: 'Langue',
    ...
    voiceOnLabel: 'Activer la voix',
    voiceOffLabel: 'Desactiver la voix',
    voiceConfirmation: '{request} demande envoyee',
  },
  zh: {
    language: '语言',
    requestsTab: '请求',
    ...
    voiceOnLabel: '开启语音',
    voiceOffLabel: '关闭语音',
    voiceConfirmation: '{request}请求已发送',
  },
  pa: {
    language: 'ਭਾਸ਼ਾ',
    requestsTab: 'ਬੇਨਤੀਆਂ',
    ...
    voiceOnLabel: 'ਆਵਾਜ਼ ਚਾਲੂ ਕਰੋ',
    voiceOffLabel: 'ਆਵਾਜ਼ ਬੰਦ ਕਰੋ',
    voiceConfirmation: '{request} ਬੇਨਤੀ ਭੇਜੀ ਗਈ',
  },
  yue: {
    language: '語言',
    requestsTab: '請求',
    ...
    voiceOnLabel: '開啟語音',
    voiceOffLabel: '關閉語音',
    voiceConfirmation: '{request}請求已經發送',
  },
  ar: {
    language: 'اللغة',
    requestsTab: 'الطلبات',
    ...
    voiceOnLabel: 'تشغيل الصوت',
    voiceOffLabel: 'إيقاف الصوت',
    voiceConfirmation: 'تم إرسال طلب {request}',
  },
  tl: {
    language: 'Wika',
    ...
    voiceOnLabel: 'I-on ang boses',
    voiceOffLabel: 'I-off ang boses',
    voiceConfirmation: 'Naipadala ang kahilingan para sa {request}',
  },
} as const
