...
const PATIENT_COPY = {
  en: {
    ...
    notifAckTitle: 'Update on your request',
    notifAckBody: 'Your {request} request has been acknowledged by the care team.',
  ...
  es: {
    ...
    notifAckTitle: 'Actualizacion de su solicitud',
    notifAckBody: 'Su solicitud de {request} ha sido reconocida por el equipo de atencion.',
  ...
  fr: {
    ...
    notifAckTitle: 'Mise a jour de votre demande',
    notifAckBody: 'Votre demande de {request} a ete prise en compte par l equipe soignante.',
  ...
  zh: {
    ...
    notifAckTitle: '请求更新',
    notifAckBody: '您的{request}请求已被护理团队确认。',
  ...
  pa: {
    ...
    notifAckTitle: 'ਤੁਹਾਡੀ ਬੇਨਤੀ ਬਾਰੇ ਅੱਪਡੇਟ',
    notifAckBody: 'ਤੁਹਾਡੀ {request} ਬੇਨਤੀ ਨੂੰ ਦੇਖਭਾਲ ਟੀਮ ਨੇ ਮੰਨ ਲਿਆ ਹੈ।',
  ...
  yue: {
    ...
    notifAckTitle: '您嘅請求有更新',
    notifAckBody: '您嘅{request}請求已被護理團隊確認。',
  ...
  ar: {
    ...
    notifAckTitle: 'تحديث بشأن طلبك',
    notifAckBody: 'تم استلام طلب {request} من قبل فريق الرعاية.',
  ...
  tl: {
    ...
    noNotifications: 'Walang notification pa',
    notifAckTitle: 'Update sa iyong request',
    notifAckBody: 'Ang iyong {request} request ay kinilala na ng care team.',
